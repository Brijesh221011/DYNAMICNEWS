...
const Comment = ({comment,onLike,onEdit,onDelete}) => {
  ...
  return (
    <div className='flex p-4 border-slate-300 text-sm gap-2'>
        ...
        <div className="flex-1">
            ...
            <div className="flex items-center pt-2 text-sm border-t border-slate-300
            max-w-fit gap-2">
              <button 
               type='button'
              ...
              <AlertDialogAction className='bg-red-500' onClick={()=>onDelete(comment._id)}>Continue</AlertDialogAction>
               </AlertDialogFooter>
               </AlertDialogContent>
              </AlertDialog>
                    </>
