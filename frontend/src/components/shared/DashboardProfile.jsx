   ...
   const handleSubmit=async (e)=>{
    e.preventDefault();
      ...
      try {
       ...
       console.log("Sending request with token:", currentUser.token); // Debugging
    ...
    <div className='max-w-lg mx-auto p-3 w-full'>
      ...
      <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
        ...
        <div className="w-32 h-32 self-center cursor-pointer overflow-hidden">
          <img src={imageFileUrl || currentUser.profilePicture}
           alt='' className='rounded-full w-full h-full object-cover border-8 border-gray-300'
        ...
        className="h-12 border-slate-400 focus-visible:ring-0 
      ...
      <div className="text-red-500 flex justify-between mt-5">
        ...
        <AlertDialogFooter>
          ...
          <AlertDialogAction className='bg-red-500' onClick={handleDeleteUser}>Continue</AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
        </AlertDialog>
