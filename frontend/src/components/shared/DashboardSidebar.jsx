       ...
       <nav className='flex-1 p-4'>
        <ul className='space-y-2'>
            ...
            {currentUser && currentUser.isAdmin && (
              <li>
              <Link to={"/dashboard?tab=dashboard"} className="flex items-center p-2
            ...
            <Link to={"/dashboard?tab=profile"} className="flex items-center p-2
             ...
             {currentUser && currentUser.isAdmin && (
              <li>
              <Link to={"/dashboard?tab=posts"} className="flex items-center p-2
               hover:bg-slate-300 rounded">
            ...
            {currentUser && currentUser.isAdmin && (
              <li>
              <Link to={"/dashboard?tab=users"} className="flex items-center p-2
               hover:bg-slate-300 rounded">
            ...
            {currentUser && currentUser.isAdmin && (
              <li>
              <Link to={"/dashboard?tab=comments"} className="flex items-center p-2
               hover:bg-slate-300 rounded">
        ...
        <div className="p-4 border-t border-gray-700">
            <button
           className='flex item-center w-full p-2 hover:bg-slate-300 rounded'
