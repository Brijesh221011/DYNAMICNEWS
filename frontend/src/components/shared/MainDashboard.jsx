...
import { convertToReadable } from '@/lib/utils';
  ...
  return (
    <div className='p-3 md:mx-auto'>
       <div className="flex-wrap flex gap-4 justify-center">
        <DashboardCard 
         title="All Users" 
         description={`${convertToReadable(currentUser.createdAt)}-${convertToReadable(Date.now())}`}
        ...
        <DashboardCard 
         ...
         description={`${convertToReadable(currentUser.createdAt)}-${convertToReadable(Date.now())}`}
          ...
          footerText={"Showing total post for all time"}
          endAngle={110}
          />
       </div>
