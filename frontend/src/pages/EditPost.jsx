  ...
  const handleUploadImage=async()=>{
    try {
      ...
      const uploadedFile=await uploadFile(file);
       const postImageUrl = (await getFilePreview(uploadedFile)).toString();
      ...
      <h1 className='text-center text-3xl my-7 font-semibold text-slate-700'>
        ...
        <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
          <div className="flex flex-col gap-4 sm:flex-row justify-between">
            <Input 
              ...
              <SelectTrigger className="w-full sm:w-1/4 h-12 border border-slate-400
               ...
               <SelectItem value="sportnews">Sport News</SelectItem>
          ...
          <div className="flex gap-4 items-center justify-between border-4
           ...
           className='h-72 mb-12' required onChange={(value)=>{
