...
const Search = () => {
  ...
  return (
    ...
    <div className='flex flex-col md:flex-row'>
        {/* Sidebar */}
        <aside 
          className='p-6 md:w-1/4 bg-white shadow-md border-r
          border-gray-300'>
          ...
          <Select
            ...
            <SelectValue placeholder="Select a category" />
             ...
             <SelectItem value="worldnews">World News</SelectItem>
              <SelectItem value="sportsnews">Sport News</SelectItem>
        ...
        <div className="w-full">
          ...
          <div className="p-7 flex flex-wrap gap-4">
            ...
            { !loading && posts && 
              ...
              { showMore && (
                <button onClick={handleShowMore} className='text-slate-800 text-lg hover:underline p-7 w-full'>
                  Show More
                </button>
              )}
          </div>
